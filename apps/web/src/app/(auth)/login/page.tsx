          ...
          <div className="p-8">
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-border px-4 py-2 text-sm font-semibold hover:bg-bg-secondary hover:border-text-secondary hover:-translate-y-0.5 active:translate-y-0 transition-all duration-150"
              >
