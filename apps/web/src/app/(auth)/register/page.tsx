      ...
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-border bg-bg/80 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 md:px-6">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <Link href="/login">
              <span className="text-sm font-semibold text-text-secondary transition-colors hover:text-text">
                Log In
              </span>
            </Link>
            <span className="cursor-default rounded-full bg-primary px-5 py-1.5 text-sm font-semibold text-white">
              Sign Up
            </span>
          </div>
        </div>
          ...
          >
            ...
            <div className="relative z-10 mt-10 text-center">
              ...
              <p className="mt-2 max-w-sm text-sm text-white/60">
                Create your account and start sharing moments with friends
                around the world.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-1 items-center justify-center px-4 py-8 md:px-8">
            <div className="w-full max-w-[350px] space-y-3">
              ...
              <div className="rounded-xl border border-border bg-bg px-8 py-10 shadow-sm">
                ...
                {/* Terms notice */}
                <p className="mt-5 text-center text-[11px] leading-tight text-text-secondary">
      ...
      <footer className="border-t border-border bg-bg-tertiary/50 py-6">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="mb-4 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs text-text-secondary">
            <Link href="/meta" className="hover:text-text">Meta</Link>
            ...
            <Link href="/help" className="hover:text-text">Help</Link>
            <Link href="/api" className="hover:text-text">API</Link>
            <Link href="/privacy" className="hover:text-text">Privacy</Link>
            <Link href="/terms" className="hover:text-text">Terms</Link>
            <Link href="/locations" className="hover:text-text">Locations</Link>
            <Link href="/blink-lite" className="hover:text-text">Blink Lite</Link>
          </div>
